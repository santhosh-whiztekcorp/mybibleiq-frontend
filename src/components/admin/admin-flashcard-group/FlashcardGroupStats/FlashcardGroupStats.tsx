...
import { FlashcardGroupStatsProps } from "./FlashcardGroupStats.types";
import { useFlashcardGroupStats } from "./FlashcardGroupStats.hooks";

export function FlashcardGroupStats({ stats, isLoading }: FlashcardGroupStatsProps) {
  const { items } = useFlashcardGroupStats(stats);
