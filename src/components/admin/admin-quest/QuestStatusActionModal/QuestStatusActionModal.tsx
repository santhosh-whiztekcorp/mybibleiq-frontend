...
import { useQuestStatusActionModal } from "./QuestStatusActionModal.hooks";
import type { QuestStatusActionModalProps } from "./QuestStatusActionModal.types";

export function QuestStatusActionModal(props: QuestStatusActionModalProps) {
  const { open, onOpenChange, onConfirm } = props;
  const { item, config, isLoading } = useQuestStatusActionModal(props);
