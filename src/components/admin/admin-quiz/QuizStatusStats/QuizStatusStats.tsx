...
import { QuizStatusStatsProps } from "./QuizStatusStats.types";
import { useQuizStatusStats } from "./QuizStatusStats.hooks";
import { cn } from "@/lib/utils";

export function QuizStatusStats({ stats, isLoading }: QuizStatusStatsProps) {
  const { items } = useQuizStatusStats(stats);
