  ...
  "inline-flex items-center justify-center rounded-lg border w-fit whitespace-nowrap shrink-0 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] transition-[color,box-shadow]",
  {
    variants: {
      variant: {
        ...
        statusDraft: "bg-gray-100 border-gray-300 text-gray-700",
        ...
        categoryBugReport: "bg-[#DCE0FF] border-[#BFC5FF] text-[#7649AD]",
        categoryFeatureRequest: "bg-[#DBE9FF] border-[#C4D3F8] text-[#1447E6]",
        categoryGeneralFeedback: "bg-[#E8F5E9] border-[#CCFECD] text-[#2E7D32]",
        categoryOther: "bg-[#FFF9C1] border-[#FCDEA4] text-[#935C34]",
      },
      size: {
