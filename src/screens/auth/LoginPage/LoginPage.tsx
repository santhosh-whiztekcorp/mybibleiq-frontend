    ...
    <div className="flex min-h-screen items-center justify-center bg-white px-5 py-5 font-plus-jakarta-sans">
      <div className="w-full max-w-[350px] space-y-6">
        ...
        <p className="text-xs text-[#6b7280] text-center leading-relaxed font-medium font-plus-jakarta-sans m-0">
          ...
          <Link href={ROUTES.TERMS_CONDITIONS} className="text-[#1877F2] underline hover:text-[#1877F2]/90">
            terms & condition
          </Link>{" "}
          and{" "}
          <Link href={ROUTES.PRIVACY_POLICY} className="text-[#1877F2] underline hover:text-[#1877F2]/90">
            privacy policy
          </Link>
        </p>
