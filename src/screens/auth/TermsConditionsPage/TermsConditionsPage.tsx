...
import { useGetTermsAndConditions } from "@/resources/user-settings";
import { ROUTES } from "@/constants/routes";
import { formatDate } from "@/utils/formatting";

export function TermsConditionsPage() {
  const { data, isLoading, error } = useGetTermsAndConditions();
      ...
      <div className="max-w-3xl mx-auto px-5 py-10">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <p className="text-sm text-[#6b7280]">Loading Terms &amp; Conditions…</p>
          </div>
        ) : showError ? (
          ...
          <>
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-[#1f2937] mb-2">{displayData?.title || "Terms & Conditions"}</h1>
